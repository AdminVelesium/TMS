...
const WorkloadDistributionChart = () => {
  ...
  return (
    <div style={{ padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "20px", fontFamily: 'Montserrat' }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              ...
              />
              <h1 style={{ fontSize: "20px", fontWeight: "600", margin: 0, color: '#000' }}>Admin</h1>
            </div>
          </div>
      ...
      <div style={{ display: "flex", width: "100%" }}>
        ...
        <main
          style={{
            ...
            overflowX: "hidden",
            margin: "0 auto",
            maxWidth: "1920px", // Add max-width for very large screens
          }}
        >
